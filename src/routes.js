...
const routes = [
  {
    ...
    guard: GuestGuard,
    path: '/register',
    component: lazy(() => import('./views/auth/signup/Register')),
  },  
  {
    exact: true,
    path: '/faq',
    component: lazy(() => import('./views/shared/faq'))
  },
  {
    exact: true,
    path: '/privacypolicy',
    component: lazy(() => import('./views/shared/Privacypolicy'))
  },
  {
    exact: true,
    path: '/termsofuse',
    component: lazy(() => import('./views/shared/Termsofuse'))
  },
  {
    exact: true,
    path: '/home',
    component: lazy(() => import('./views/auth/signup/Thankyou'))
  },
  {
    exact: true,
    path: '/success',
    component: lazy(() => import('./views/auth/signup/ThankyouBusiness'))
  },
  {
    exact: true,
    path: '/404',
