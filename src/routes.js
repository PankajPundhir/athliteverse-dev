...
const routes = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        exact: true,
        path: '/app/tokenwalletdetails',
        component: lazy(() => import('./views/token-wallet/token-wallet-detail'))
      },
      {
        exact: true,
        path: '/app/gametokendetails',
        component: lazy(() => import('./views/token-wallet/game-token-detail.js'))
      },
      {
        exact: true,
        path: '/app/orders',
